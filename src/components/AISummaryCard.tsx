      ...
      <div className="flex justify-between items-center gap-6">
        ...
        <div className="hidden sm:block flex-shrink-0 relative w-20 h-20 opacity-80 select-none">
          ...
          >
            ...
            <circle cx="20" cy="50" r="2.5" className="fill-neutral-450 text-neutral-450" />
            <circle cx="80" cy="50" r="2.5" className="fill-neutral-450 text-neutral-450" />
            <circle cx="35" cy="30" r="2.5" className="fill-[#F04D22] text-[#F04D22]" />
            <circle cx="65" cy="30" r="2.5" className="fill-[#F04D22] text-[#F04D22]" />
            <circle cx="35" cy="62" r="2.5" className="fill-neutral-450 text-neutral-450" />
            <circle cx="65" cy="62" r="2.5" className="fill-neutral-450 text-neutral-450" />
