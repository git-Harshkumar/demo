...
export function Tags() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-6 select-none font-sans">
      {/* Tasks Card */}
      <div className="bg-white rounded-xl border border-neutral-200 p-5 shadow-sm transition-all hover:shadow-md">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-bold text-black tracking-[-0.02em]">Tasks</h3>
          </div>
        ...
        <div className="flex flex-wrap gap-2">
          {taskTags.map((tag) => (
            <Pill key={tag} variant="task" className="px-2.5 py-1 text-xs rounded">
              {tag}
            </Pill>
          ))}
        </div>
      ...
      <div className="bg-white rounded-xl border border-neutral-200 p-5 shadow-sm transition-all hover:shadow-md">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-bold text-black tracking-[-0.02em]">Methods</h3>
          </div>
          <span className="text-[10px] font-bold text-neutral-450 bg-[#F5F5F5] px-2 py-0.5 rounded font-mono border border-neutral-200">
        ...
        <div className="flex flex-wrap gap-2">
          {methodTags.map((tag) => (
            <Pill key={tag} variant="method" className="px-2.5 py-1 text-xs rounded">
              {tag}
            </Pill>
          ))}
        </div>
